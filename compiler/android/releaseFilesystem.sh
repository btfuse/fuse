...
files=(
    "plugins/filesystem/android/filesystem/build/outputs/aar/filesystem-debug.aar"
    "plugins/filesystem/android/filesystem/build/outputs/aar/filesystem-release.aar"
)
